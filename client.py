...
# Define SUMO_HOME para Windows (ajusta esta ruta según tu instalación real)
os.environ['SUMO_HOME'] = r'C:\Program Files (x86)\Eclipse\Sumo'

# Verifica si SUMO_HOME está definido
        ...
        while self.env is None:
            try:
                self.env = SumoEnvironment(
                    ...
                    additional_sumo_cmd="--tripinfo-output output/tripinfo_cliente{}.xml".format(self.client_id)
                )
